...
type Exec struct {
	...
	PasswordChangeAt    sql.NullString `json:"password_change_at,omitempty" db:"password_change_at,omitempty"`
	...
	PasswordTokenExpire sql.NullString `json:"password_token_expire,omitempty" db:"password_token_expire,omitempty"`
